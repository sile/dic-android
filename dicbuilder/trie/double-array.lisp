(defpackage dic.trie.double-array
  (:use :common-lisp :dic.util)
  (:export build
           load-dic
           get-id))
(in-package :dic.trie.double-array)

(package-alias :pairing-heap :heap)
(package-alias :dic.trie :trie)
(package-alias :dic.trie.code-stream :code-stream)
(package-alias :dic.trie.node-allocator :node-allocator)
...
(package-alias :dic.trie.node-allocator)
